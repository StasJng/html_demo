...
--------------------------------------------------------
  ...
  --changePassword
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN no_data_found -- User kh�ng t?n t?i
        THEN 
    ...
    BEGIN
        ...
        WHEN No_Data_Found 
        THEN 
            OPEN ret FOR SELECT '-2' FROM dual; -- 2:Account kh�ng t?n t?i!
        WHEN OTHERS 
        THEN 
            OPEN ret FOR SELECT '0' FROM dual; -- 0:X?y ra l?i kh�c trong qu� tr�nh c?p nh?t.
  ...
  BEGIN
    --T?ng s? deal ?ang ho?t ??ng tr�n Dealtoday
